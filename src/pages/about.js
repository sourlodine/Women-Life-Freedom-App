    ...
    <div className="w-full mx-auto py-5 lg:py-0  h-full min-h-screen max-w-[1200px]">
      <div className="gap-10 justify-center text-start flex flex-col lg:flex-row mt-44 px-6">
        <div className="w-full lg:w-1/2 justify-start mb-12 gap-10 flex flex-col">
          <div className="text-white font-bold text-3xl">Our Story</div>
          <div className="flex flex-col gap-5">
            <h3 className="text-lg text-white">
              As the one-year anniversary of Mahsa Amini’s death rapidly
              approaches, thoughts of the people of Iran, especially those in my
              family who remain there, have raced through my head every day.
            </h3>
            <h3 className="text-lg text-white">Enter Project 0xWLF.</h3>
            <h3 className="text-lg text-white">
              Leveraging blockchain technology - which emphasizes the freedom to
              create and transact - is the best way I know how to help the
              people of Iran.
            </h3>
            <h3 className="text-lg text-white">
        ...
        <div className="w-full lg:w-1/2 justify-start gap-10 flex flex-col text-start mb-12">
          ...
          <div className="relative w-full mx-auto">
            <div
              ...
              className="cursor-pointer text-white/60 hover:text-white bg-[#ffffff0d] backdrop-filter flex items-center justify-between px-[30px] py-[24px] font-bold text-[18px] lg:text-[24px] mt-[10px] "
            >
              Wen Drop?
            ...
            <div
              onClick={() => dropDownText5()}
              className="cursor-pointer text-white/60 hover:text-white bg-[#ffffff0d] backdrop-filter flex items-center justify-between px-[30px] py-[24px] font-bold text-[18px] lg:text-[24px] mt-[10px] "
            >
              Where will the funds be donated?
              <div className="text-[24px]">
                {currentDropDown5 ? <FiMinus /> : <FiPlus />}
              </div>
            </div>
            <div
              className={`${
                currentDropDown5 ? "py-[24px]" : ""
              } px-[29px] text-start text-white/60 bg-[#ffffff0d] backdrop-filter duration-300`}
            >
              <span
                className={`${
              ...
              >
                We are excited to donate all proceeds to the Iranian Diaspora
                Collective’s “Keep Iran Online” initiative. Journalists are not
                allowed in Iran. Thus, social media is the only way Iranians can
                document and disseminate what’s really happening in Iran. In the
                face of regime crackdowns on internet connectivity, it is of
                paramount importance that we protect the connectivity of the
                young Iranians who are leading this movement.
